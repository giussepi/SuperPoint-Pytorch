...
SUPPORTED_DBS = ('synthetic', 'hpatches')
SUPPORTED_MODELS = ('superpoint', 'magicpoint')
...
if __name__ == "__main__":
    ...
    assert config['data']['name'] in SUPPORTED_DBS
    assert config['model']['name'] in SUPPORTED_MODELS
    ...
    if config['data']['name'] == SUPPORTED_DBS[0]:  # synthetic
    ...
    if config['model']['name'] == SUPPORTED_MODELS[0]:  # 'superpoint'
